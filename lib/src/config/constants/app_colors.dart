...
class AppColors {
  ...
  static List<Color> storyColors2 = [
    const Color.fromARGB(255, 59, 108, 255),
    Color.fromARGB(255, 92, 238, 246),
    const Color.fromARGB(255, 140, 0, 255),
    const Color.fromARGB(255, 54, 244, 171),
    Color.fromARGB(255, 140, 88, 231),
  ];

  static Color blue = const Color.fromARGB(255, 36, 99, 170);

  static Color lightblue = const Color.fromARGB(255, 152, 187, 232);

  static Color green = const Color.fromARGB(255, 80, 156, 85);
